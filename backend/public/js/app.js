...
function app() {
  return {
    ...
    addEvent: function addEvent() {
      ...
      console.log(_typeof(this.event_date), _typeof(this.event_text), _typeof(this.event_date));
      this.events.push({
      ...
      console.log(_typeof(this.events)); // clear the form data
    ...
    readEvent: function readEvent() {
      ...
      var selectMonth = String(this.year) + '-' + ("00" + (this.month + 1)).slice(-2);
      var $this = this;
      console.log(user_id);
    ...
    getNoOfWeekDays: function getNoOfWeekDays() {
      var now = new Date();
      var today = now.getDate();
      var weekDay = now.getDay();
      var startOfweek = today - weekDay;
      var daysArray = [];

      for (var i = 0; i < 7; i++) {
        var day = startOfweek + i;
        daysArray.push(day);
      }

      this.no_of_week_days = daysArray;
    }
  };
}
